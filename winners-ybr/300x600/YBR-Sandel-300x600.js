...
lib.ssMetadata = [
		{name:"YBR_Sandel_300x600_atlas_1", frames: [[906,412,451,128],[604,601,268,82],[1510,0,509,172],[0,602,312,75],[604,0,300,599],[0,0,300,600],[1661,557,300,140],[1719,368,300,187],[1510,174,207,307],[1208,542,133,232],[314,602,156,36],[906,0,300,410],[302,0,300,600],[1359,483,300,144],[1208,0,300,386],[1359,388,82,82],[906,542,300,144],[1719,174,300,192]]}
];
...
(lib.CachedBmp_66 = function() {
	this.initialize(ss["YBR_Sandel_300x600_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-130.5,-35.4,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.BET250, new cjs.Rectangle(-130.5,-35.4,225.5,64), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-76.65,-22.6,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.ANDWON, new cjs.Rectangle(-76.6,-22.6,134,41), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-144.95,-47.85,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib._10399, new cjs.Rectangle(-144.9,-47.8,254.5,86), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-78,-20.7,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.WINNOW, new cjs.Rectangle(-78,-20.7,156,37.5), null);
...
}).prototype = getMCSymbolPrototype(lib.CTABUTTON_1, new cjs.Rectangle(-78,-18,156,36), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-150,-205);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Cutout_1, new cjs.Rectangle(-150,-205,300,410), null);


// stage content:
(lib.YBRSandel300x600 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(-82.9,543.55,1,1,0,0,0,0.1,-2);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(47).to({_off:false},0).to({x:98.05},11,cjs.Ease.backOut).wait(62));

	// CTA_BUTTON
	this.instance_1 = new lib.CTABUTTON_1();
	this.instance_1.setTransform(-82.95,544);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(47).to({_off:false},0).to({x:98},11,cjs.Ease.backOut).wait(62));

	// $10_399
	this.instance_2 = new lib._10399();
	this.instance_2.setTransform(150,122.9,0.0039,0.0116,0,0,0,-12.8,-4.3);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(24).to({_off:false},0).to({regX:-17.7,regY:-5,scaleX:1,scaleY:1,x:152.1,y:118},23,cjs.Ease.elasticOut).wait(73));

	// AND_WON
	this.instance_3 = new lib.ANDWON();
	this.instance_3.setTransform(374.2,73.5,1,1,0,0,0,-9.8,-2.1);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(12).to({_off:false},0).to({x:150.35},12,cjs.Ease.backOut).wait(96));

	// BET_$2_50
	this.instance_4 = new lib.BET250();
	this.instance_4.setTransform(-121.8,32.9,1,1,0,0,0,-17.8,-3.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({x:147.15},12,cjs.Ease.backOut).wait(108));

	// YBR_Logo
	this.instance_5 = new lib.YBRLogo();
	this.instance_5.setTransform(198,503);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(120));

	// TEXTURE
	this.instance_6 = new lib.TEXTURE();
	this.instance_6.setTransform(0,456);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(120));

	// Black_Box
	this.instance_7 = new lib.BlackBox();
	this.instance_7.setTransform(0,460);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(120));

	// Yellow_Box
	this.instance_8 = new lib.YellowBox();
	this.instance_8.setTransform(0,456);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(120));

	// Cutout
	this.instance_9 = new lib.Cutout_1();
	this.instance_9.setTransform(150,395);

	this.timeline.addTween(cjs.Tween.get(this.instance_9).to({scaleX:1.0833,scaleY:1.0833,x:149.95,y:387.5},119).wait(1));
	...
	// Rectangle_1_copy_12
	this.instance_16 = new lib.Rectangle1copy12();
...
p.nominalBounds = new cjs.Rectangle(-84.5,299,525.9,310.6);
// library properties:
lib.properties = {
	id: '004B339C4EB44090A8B51BDAE0AF7278',
	width: 300,
	height: 600,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/YBR_Sandel_300x600_atlas_1.png?1623016728486", id:"YBR_Sandel_300x600_atlas_1"}
	],
	preloads: []
};
...
an.compositions['004B339C4EB44090A8B51BDAE0AF7278'] = {
