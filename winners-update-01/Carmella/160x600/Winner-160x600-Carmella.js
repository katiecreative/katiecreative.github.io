...
lib.ssMetadata = [
		{name:"Winner_160x600_Carmella_atlas_1", frames: [[778,176,240,60],[324,0,290,173],[324,175,234,100],[162,0,160,333],[778,0,160,174],[662,238,150,40],[0,0,160,336],[560,217,100,79],[616,0,160,215]]}
];
...
(lib.CachedBmp_51 = function() {
	this.initialize(ss["Winner_160x600_Carmella_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-65.95,-17.25,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.WINNOW, new cjs.Rectangle(-65.9,-17.2,120,30), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-91.15,-43.15,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib._9213Jackpot, new cjs.Rectangle(-91.1,-43.1,145,86.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-70.3,-25.6,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib._4Bet, new cjs.Rectangle(-70.3,-25.6,117,50), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-80,-168);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Cutout_1, new cjs.Rectangle(-80,-168,160,336), null);
...
// stage content:
(lib.Winner160x600Carmella = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance_6.setTransform(80,309);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({regX:0.2,regY:0.3,scaleX:1.0937,scaleY:1.0937,y:322.35},119).wait(1));
	...
	this.instance_8.setTransform(0,141);
...
p.nominalBounds = new cjs.Rectangle(-76,250.4,261.8,350.6);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Winner_160x600_Carmella_atlas_1.png?1622771047560", id:"Winner_160x600_Carmella_atlas_1"}
	],
	preloads: []
};
