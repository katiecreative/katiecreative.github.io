...
lib.ssMetadata = [
		{name:"Winners_300x600_Maryann_atlas_1", frames: [[0,645,542,117],[0,0,574,212],[544,645,300,143],[302,398,300,245],[576,0,300,396],[0,214,300,353],[302,214,100,79]]}
];
...
(lib.CachedBmp_35 = function() {
	this.initialize(ss["Winners_300x600_Maryann_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-154.45,-27.3,0.4575,0.4575);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Catherinewon, new cjs.Rectangle(-154.4,-27.3,247.9,53.5), null);
...
}).prototype = getMCSymbolPrototype(lib._10132, new cjs.Rectangle(-143.4,-52.9,287,106), null);
...
// stage content:
(lib.Winners300x600Maryann = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(this.prize_mc).wait(13).to({_off:false},0).to({regX:0.1,scaleX:0.9997,scaleY:0.9997,x:150.1,y:114},29,cjs.Ease.elasticOut).wait(78));

	// Catherine_won
	this.winner_mc = new lib.Catherinewon();
	this.winner_mc.name = "winner_mc";
	this.winner_mc.setTransform(-154.5,52.35,1.093,1.0919,0,0,0,-30.7,-0.6);
	this.winner_mc.shadow = new cjs.Shadow("rgba(0,0,0,1)",0,0,2);

	this.timeline.addTween(cjs.Tween.get(this.winner_mc).to({regX:-27.7,regY:2.4,scaleX:1.0929,scaleY:1.089,x:151.75,y:55.6},15,cjs.Ease.backOut).wait(105));
...
p.nominalBounds = new cjs.Rectangle(-147.7,299,492.2,302);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Winners_300x600_Maryann_atlas_1.png?1615578112239", id:"Winners_300x600_Maryann_atlas_1"}
	],
	preloads: []
};
