...
lib.ssMetadata = [
		{name:"Winners_160x600_Maryann_atlas_1", frames: [[0,0,288,184],[614,226,299,116],[776,0,160,169],[614,0,160,224],[290,0,160,330],[452,0,160,297],[915,171,98,77]]}
];
...
(lib.CachedBmp_39 = function() {
	this.initialize(ss["Winners_160x600_Maryann_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-80,-148.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.TS_Maryann_SyracuseNY_40163_FuNanFuNu_088wager_Feb142_1, new cjs.Rectangle(-80,-148.5,160,297), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-96.95,-46.6,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Catherinewon, new cjs.Rectangle(-96.9,-46.6,144,92), null);
...
}).prototype = getMCSymbolPrototype(lib._10132, new cjs.Rectangle(-74.6,-29,149.1,57.9), null);
...
// stage content:
(lib.Winners160x600Maryann = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(this.prize_mc).wait(12).to({_off:false},0).to({regX:0.1,regY:5.9,scaleX:1.0024,scaleY:1.0015,x:80.1,y:137.8},29,cjs.Ease.elasticOut).wait(79));

	// Kathy_won
	this.winner = new lib.Catherinewon();
	this.winner.name = "winner";
	this.winner.setTransform(80.05,-40.5,1,1,0,0,0,-25,6.5);
	this.winner.shadow = new cjs.Shadow("rgba(0,0,0,1)",0,0,1);

	this.timeline.addTween(cjs.Tween.get(this.winner).to({y:86.5},14,cjs.Ease.backOut).wait(106));
	...
	this.instance_1.setTransform(0,413.05,1,1.1302);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(120));

	// TS_Maryann_SyracuseNY_$40163_FuNanFuNu_$0_88wager_Feb14_2
	this.instance_2 = new lib.TS_Maryann_SyracuseNY_40163_FuNanFuNu_088wager_Feb142_1();
	this.instance_2.setTransform(80,322.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({scaleX:1.125,scaleY:1.1249,y:322.45},119).wait(1));
	...
	this.instance_4.setTransform(0,144);
...
p.nominalBounds = new cjs.Rectangle(54.9,202.4,132,401.70000000000005);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Winners_160x600_Maryann_atlas_1.png?1615578630571", id:"Winners_160x600_Maryann_atlas_1"}
	],
	preloads: []
};
