...
lib.ssMetadata = [
		{name:"Winners_1024x768_Maryann_atlas_1", frames: [[0,1150,1335,207],[1026,669,829,231],[0,0,1024,768],[1026,0,809,667],[0,770,1024,378],[1837,0,174,136]]}
];
...
(lib.CachedBmp_27 = function() {
	this.initialize(ss["Winners_1024x768_Maryann_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.Winners1024x768Maryann = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.shape_1.graphics.f().s("#000000").ss(2,1,1).p("EhP/g7/MCf/AAAMAAAB3/Mif/AAAg");
	this.shape_1.setTransform(512,384);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape}]}).to({state:[{t:this.shape_1}]},76).wait(44));
	...
	this.shape_2.graphics.f().s("#000000").ss(1,1,1).p("EhP/g7/MCf/AAAMAAAB3/Mif/AAAg");
	this.shape_2.setTransform(512,384);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.button_link}]}).wait(120));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(19).to({_off:false},0).to({regX:19.6,scaleX:0.9998,scaleY:0.9998,x:248.1,y:155.3},29,cjs.Ease.elasticOut).wait(72));
	...
	this.instance_4.setTransform(530.5,434.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({regX:1.2,regY:1.3,scaleX:1.0618,scaleY:1.0617},119).wait(1));
	...
	// Maryann_Background
	this.instance_6 = new lib.MaryannBackground();
...
p.nominalBounds = new cjs.Rectangle(-524.3,383,2384.3,405.4);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Winners_1024x768_Maryann_atlas_1.png?1615576166465", id:"Winners_1024x768_Maryann_atlas_1"}
	],
	preloads: []
};
