...
lib.ssMetadata = [
		{name:"Winners_320x50_Kathy_atlas_1", frames: [[0,75,180,48],[0,0,193,73],[0,177,106,50],[0,125,152,50],[108,177,105,50],[154,125,47,37]]}
];
...
(lib.CachedBmp_15 = function() {
	this.initialize(ss["Winners_320x50_Kathy_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-58.75,-12.2,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Catherinewon, new cjs.Rectangle(-58.7,-12.2,90,24), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-48.25,-18.2,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib._10132, new cjs.Rectangle(-48.2,-18.2,96.5,36.5), null);
...
// stage content:
(lib.Winners320x50Kathy = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(this.prize_mc).wait(12).to({_off:false},0).to({scaleX:0.9997,scaleY:0.9997,x:72.8,y:34.1},29,cjs.Ease.elasticOut).wait(79));

	// Catherine_won
	this.winner_mc = new lib.Catherinewon();
	this.winner_mc.name = "winner_mc";
	this.winner_mc.setTransform(-45.7,12.5,1,1,0,0,0,-13.7,-0.2);
	this.winner_mc.shadow = new cjs.Shadow("rgba(0,0,0,1)",0,0,1);

	this.timeline.addTween(cjs.Tween.get(this.winner_mc).to({x:68.3},14,cjs.Ease.backOut).wait(106));
	...
	// Kathy_Background
	this.instance_1 = new lib.KathyBackground();
...
p.nominalBounds = new cjs.Rectangle(63.3,21.5,257.7,40.8);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Winners_320x50_Kathy_atlas_1.png?1615574617605", id:"Winners_320x50_Kathy_atlas_1"}
	],
	preloads: []
};
