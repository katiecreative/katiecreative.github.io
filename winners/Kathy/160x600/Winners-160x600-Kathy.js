...
lib.ssMetadata = [
		{name:"Winners_160x600_Kathy_atlas_1", frames: [[0,0,289,213],[615,226,293,116],[777,0,160,169],[291,0,160,277],[453,0,160,275],[615,0,160,224],[910,171,98,77]]}
];
...
(lib.CachedBmp_9 = function() {
	this.initialize(ss["Winners_160x600_Kathy_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-80,-137.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.KathyTopLayer_1, new cjs.Rectangle(-80,-137.5,160,275), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-97.3,-46.6,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Catherinewon, new cjs.Rectangle(-97.3,-46.6,144.5,106.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-73.05,-29,0.4988,0.4988);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib._10132, new cjs.Rectangle(-73,-29,146.1,57.9), null);
...
// stage content:
(lib.Winners160x600Kathy = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(this.winner).to({y:71.5},14,cjs.Ease.backOut).wait(106));
	...
	this.kathytop_mc.setTransform(80,323.5);

	this.timeline.addTween(cjs.Tween.get(this.kathytop_mc).to({scaleX:1.125,scaleY:1.1249},119).wait(1));

	// Top_Banner
	this.instance_2 = new lib.TopBanner();

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(120));

	// Kathy_Background
	this.instance_3 = new lib.KathyBackground();
	this.instance_3.setTransform(0,184);
...
p.nominalBounds = new cjs.Rectangle(57.1,202.4,127,401.70000000000005);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Winners_160x600_Kathy_atlas_1.png?1615574126008", id:"Winners_160x600_Kathy_atlas_1"}
	],
	preloads: []
};
