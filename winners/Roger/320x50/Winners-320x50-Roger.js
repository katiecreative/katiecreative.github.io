...
lib.ssMetadata = [
		{name:"Winners_320x50_Roger_atlas_1", frames: [[0,75,184,48],[0,0,197,73],[0,177,109,50],[0,125,152,50],[111,177,105,50],[154,125,47,37]]}
];
...
(lib.CachedBmp_48 = function() {
	this.initialize(ss["Winners_320x50_Roger_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-59.75,-12.2,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Catherinewon, new cjs.Rectangle(-59.7,-12.2,92,24), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-49.25,-18.2,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib._10132, new cjs.Rectangle(-49.2,-18.2,98.5,36.5), null);
...
// stage content:
(lib.Winners320x50Roger = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(this.prize_mc).wait(12).to({_off:false},0).to({scaleX:0.9997,scaleY:0.9997,x:73.8,y:34.1},29,cjs.Ease.elasticOut).wait(79));

	// Catherine_won
	this.winner_mc = new lib.Catherinewon();
	this.winner_mc.name = "winner_mc";
	this.winner_mc.setTransform(-46.7,12.5,1,1,0,0,0,-13.7,-0.2);
...
p.nominalBounds = new cjs.Rectangle(61.3,21.5,259.7,40.8);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Winners_320x50_Roger_atlas_1.png?1615580589703", id:"Winners_320x50_Roger_atlas_1"}
	],
	preloads: []
};
