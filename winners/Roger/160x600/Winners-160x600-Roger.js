...
lib.ssMetadata = [
		{name:"Winners_160x600_Roger_atlas_1", frames: [[0,0,288,206],[614,226,299,116],[290,0,160,311],[452,0,160,298],[776,0,160,169],[614,0,160,224],[915,171,98,77]]}
];
...
(lib.CachedBmp_42 = function() {
	this.initialize(ss["Winners_160x600_Roger_atlas_1"]);
	this.gotoAndStop(0);
...
}).prototype = getMCSymbolPrototype(lib.Catherinewon, new cjs.Rectangle(-96.9,-46.6,144,103), null);
...
// stage content:
(lib.Winners160x600Roger = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(this.winner).to({y:76.5},14,cjs.Ease.backOut).wait(106));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Winners_160x600_Roger_atlas_1.png?1615580076687", id:"Winners_160x600_Roger_atlas_1"}
	],
	preloads: []
};
