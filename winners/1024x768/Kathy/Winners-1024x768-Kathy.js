...
lib.ssMetadata = [
		{name:"Winners_1024x768_Kathy_atlas_1", frames: [[0,1150,1335,207],[1026,675,829,231],[1026,0,1006,673],[0,0,1024,768],[0,770,1024,378],[1857,675,174,136]]}
];
...
(lib.CachedBmp_4 = function() {
	this.initialize(ss["Winners_1024x768_Kathy_atlas_1"]);
	this.gotoAndStop(0);
...
(lib.Kathy_0006_KathyBackgroundpsd = function() {
	this.initialize(ss["Winners_1024x768_Kathy_atlas_1"]);
	this.gotoAndStop(3);
}).prototype = p = new cjs.Sprite();
...
// stage content:
(lib.Winners1024x768Kathy = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// _2165
	this.instance = new lib._22165();
	this.instance.setTransform(221.2,152.65,0.0026,0.0109,0,0,0,19.2,9.2);
	this.instance.shadow = new cjs.Shadow("rgba(0,0,0,1)",0,1,4);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(19).to({_off:false},0).to({scaleX:0.9998,scaleY:0.9998,x:242.9,y:162.15},29,cjs.Ease.elasticOut).wait(72));

	// Kathy_Won
	this.instance_1 = new lib.KathyWon();
	this.instance_1.setTransform(-128.3,59.05,1,0.9998,0,0,0,0.7,0.6);
	this.instance_1.shadow = new cjs.Shadow("rgba(0,0,0,1)",0,1,4);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(6).to({_off:false},0).to({regX:0,regY:0,scaleY:1,x:361.6,y:58.9},15,cjs.Ease.backOut).wait(99));
	...
	this.instance_4.setTransform(521,431.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({regX:1.3,regY:1.6,scaleX:1.0497,scaleY:1.0495,x:521.1},119).wait(1));
	...
	// Kathy_Background
	this.instance_6 = new lib.Kathy_0006_KathyBackgroundpsd();
...
p.nominalBounds = new cjs.Rectangle(-524.3,380.7,2384.3,403.8);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Winners_1024x768_Kathy_atlas_1.png?1615329601633", id:"Winners_1024x768_Kathy_atlas_1"}
	],
	preloads: []
};
