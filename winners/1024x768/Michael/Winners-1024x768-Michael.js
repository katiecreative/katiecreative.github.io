...
lib.ssMetadata = [
		{name:"Winners_1024x768_Michael_atlas_1", frames: [[0,1150,1335,207],[1026,658,829,231],[0,0,1024,768],[1026,0,849,656],[0,770,1024,378],[1026,891,174,136]]}
];
...
(lib.CachedBmp_7 = function() {
	this.initialize(ss["Winners_1024x768_Michael_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.Winners1024x768Michael = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(19).to({_off:false},0).to({scaleX:0.9997,scaleY:0.9997,x:232.6,y:157.25},29,cjs.Ease.elasticOut).wait(72));
	...
	// Michael_Top_Layer
	this.instance_4 = new lib.MichaelTopLayer_1();
	this.instance_4.setTransform(577.05,440);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({scaleX:1.0589,scaleY:1.0588,x:577,y:439.95},119).wait(1));
	...
	// Michael_Background
	this.instance_6 = new lib.MichaelBackground();
...
p.nominalBounds = new cjs.Rectangle(-524.3,381.1,2384.3,406.19999999999993);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Winners_1024x768_Michael_atlas_1.png?1615331212032", id:"Winners_1024x768_Michael_atlas_1"}
	],
	preloads: []
};
