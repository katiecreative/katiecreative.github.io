...
lib.ssMetadata = [
		{name:"WinnerAlternate_480x320_Roger_atlas_1", frames: [[482,475,231,87],[0,322,873,151],[0,475,480,152],[0,0,480,320],[482,0,332,270],[816,0,69,55]]}
];
...
(lib.CachedBmp_42 = function() {
	this.initialize(ss["WinnerAlternate_480x320_Roger_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.WinnerAlternate480x320Roger = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({scaleX:1.0903,scaleY:1.0902,y:184.95},119).wait(1));
...
p.nominalBounds = new cjs.Rectangle(-240,151.3,766,180.8);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/WinnerAlternate_480x320_Roger_atlas_1.png?1616344298260", id:"WinnerAlternate_480x320_Roger_atlas_1"}
	],
	preloads: []
};
