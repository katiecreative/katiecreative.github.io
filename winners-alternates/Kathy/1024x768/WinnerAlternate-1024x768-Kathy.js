...
lib.ssMetadata = [
		{name:"WinnerAlternate_1024x768_Kathy_atlas_1", frames: [[0,1518,1335,162],[0,770,1306,366],[1026,1138,829,231],[1026,0,1006,673],[0,1138,1024,378],[0,0,1024,768],[1026,1371,174,136]]}
];
...
(lib.CachedBmp_14 = function() {
	this.initialize(ss["WinnerAlternate_1024x768_Kathy_atlas_1"]);
	this.gotoAndStop(0);
...
(lib.TS_Kathy_WellsNY_22165_EndlessTreasure_880wager_Feb14 = function() {
	this.initialize(ss["WinnerAlternate_1024x768_Kathy_atlas_1"]);
	this.gotoAndStop(5);
}).prototype = p = new cjs.Sprite();
...
}).prototype = getMCSymbolPrototype(lib.CatherineWon, new cjs.Rectangle(-333.6,-51.8,667.5,81), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-251.6,-80.15,0.4089,0.4089);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib._10132_mc, new cjs.Rectangle(-251.6,-80.1,534,149.6), null);
...
// stage content:
(lib.WinnerAlternate1024x768Kathy = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(19).to({_off:false},0).to({scaleX:1.2228,scaleY:1.2222,x:402.45,y:128.2},29,cjs.Ease.elasticOut).wait(72));

	// Catherine_Won
	this.instance_1 = new lib.CatherineWon();
	this.instance_1.setTransform(7,87.05);
	this.instance_1.shadow = new cjs.Shadow("rgba(0,0,0,1)",0,1,2);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(6).to({_off:false},0).to({x:379.9},15,cjs.Ease.backOut).wait(99));
	...
	// Kathy_Top_Layer
	this.instance_4 = new lib.KathyTopLayer_1();
	this.instance_4.setTransform(521,492.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({regX:1.3,regY:1.6,scaleX:1.0497,scaleY:1.0495,x:521.1,y:483.7},119).wait(1));
	...
	// TS_Kathy_WellsNY__22165_EndlessTreasure__8_80wager_Feb14
	this.instance_6 = new lib.TS_Kathy_WellsNY_22165_EndlessTreasure_880wager_Feb14();
...
p.nominalBounds = new cjs.Rectangle(-524.3,350.4,2384.3,486.4);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/WinnerAlternate_1024x768_Kathy_atlas_1.png?1616340192145", id:"WinnerAlternate_1024x768_Kathy_atlas_1"}
	],
	preloads: []
};
