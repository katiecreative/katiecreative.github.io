...
lib.ssMetadata = [
		{name:"WinnerAlternate_160x600_Kathy_atlas_1", frames: [[162,505,294,91],[0,0,293,179],[0,458,160,169],[295,0,160,277],[0,181,160,275],[162,279,160,224],[162,181,98,77]]}
];
...
(lib.CachedBmp_2 = function() {
	this.initialize(ss["WinnerAlternate_160x600_Kathy_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-98.5,-46.6,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Catherinewon, new cjs.Rectangle(-98.5,-46.6,147,45.5), null);
...
}).prototype = getMCSymbolPrototype(lib._10132, new cjs.Rectangle(-73,-29,146.1,89.3), null);
...
// stage content:
(lib.WinnerAlternate160x600Kathy = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(57.1,218.4,127,382.6);
// library properties:
lib.properties = {
