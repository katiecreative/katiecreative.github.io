...
lib.ssMetadata = [
		{name:"WinnerAlternate_1024x768_Catherine_atlas_1", frames: [[0,1518,1335,162],[0,770,1306,366],[1026,1138,829,231],[0,0,1024,768],[1026,0,669,628],[0,1138,1024,378],[1337,1371,174,136]]}
];
...
(lib.CachedBmp_22 = function() {
	this.initialize(ss["WinnerAlternate_1024x768_Catherine_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.WinnerAlternate1024x768Catherine = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(-524.3,350.4,2384.3,440.9);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/WinnerAlternate_1024x768_Catherine_atlas_1.png?1616184477755", id:"WinnerAlternate_1024x768_Catherine_atlas_1"}
	],
	preloads: []
};
