...
lib.ssMetadata = [
		{name:"WinnerAlternate_160x600_Catherine_atlas_1", frames: [[324,171,287,91],[0,391,290,179],[324,0,160,169],[0,0,160,389],[162,0,160,320],[292,322,160,224],[486,0,98,77]]}
];
...
(lib.CachedBmp_18 = function() {
	this.initialize(ss["WinnerAlternate_160x600_Catherine_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-96.65,-46.6,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Catherinewon, new cjs.Rectangle(-96.6,-46.6,143.5,45.5), null);
...
}).prototype = getMCSymbolPrototype(lib._10132, new cjs.Rectangle(-72.3,-29,144.7,89.3), null);
...
// stage content:
(lib.WinnerAlternate160x600Catherine = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/WinnerAlternate_160x600_Catherine_atlas_1.png?1616183687474", id:"WinnerAlternate_160x600_Catherine_atlas_1"}
	],
	preloads: []
};
