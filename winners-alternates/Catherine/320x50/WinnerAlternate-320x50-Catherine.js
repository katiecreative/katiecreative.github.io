...
lib.ssMetadata = [
		{name:"WinnerAlternate_320x50_Catherine_atlas_1", frames: [[154,75,155,48],[0,0,417,73],[311,75,128,50],[0,75,152,50],[154,125,105,50],[261,125,47,37]]}
];
...
(lib.CachedBmp_16 = function() {
	this.initialize(ss["WinnerAlternate_320x50_Catherine_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-52.5,-12.2,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Catherinewon, new cjs.Rectangle(-52.5,-12.2,77.5,24), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-104.2,-18.2,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib._10132, new cjs.Rectangle(-104.2,-18.2,208.5,36.5), null);
...
// stage content:
(lib.WinnerAlternate320x50Catherine = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
p.nominalBounds = new cjs.Rectangle(75.5,24,245.5,31.299999999999997);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/WinnerAlternate_320x50_Catherine_atlas_1.png?1616183634065", id:"WinnerAlternate_320x50_Catherine_atlas_1"}
	],
	preloads: []
};
