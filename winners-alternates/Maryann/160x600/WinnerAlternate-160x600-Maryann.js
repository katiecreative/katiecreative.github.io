...
lib.ssMetadata = [
		{name:"WinnerAlternate_160x600_Maryann_atlas_1", frames: [[0,181,284,103],[0,0,299,179],[787,0,160,169],[625,0,160,224],[301,0,160,330],[463,0,160,297],[787,171,98,77]]}
];
...
(lib.CachedBmp_16 = function() {
	this.initialize(ss["WinnerAlternate_160x600_Maryann_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.WinnerAlternate160x600Maryann = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/WinnerAlternate_160x600_Maryann_atlas_1.png?1616341254316", id:"WinnerAlternate_160x600_Maryann_atlas_1"}
	],
	preloads: []
};
