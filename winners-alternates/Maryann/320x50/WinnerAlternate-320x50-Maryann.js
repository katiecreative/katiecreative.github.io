...
lib.ssMetadata = [
		{name:"WinnerAlternate_320x50_Maryann_atlas_1", frames: [[154,75,132,48],[0,0,421,73],[0,75,152,50],[398,75,105,50],[288,75,108,50],[423,0,47,37]]}
];
...
(lib.CachedBmp_22 = function() {
	this.initialize(ss["WinnerAlternate_320x50_Maryann_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.WinnerAlternate320x50Maryann = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance_1 = new lib.TS_Maryann_SyracuseNY_40163_FuNanFuNu_088wager_Feb14();
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/WinnerAlternate_320x50_Maryann_atlas_1.png?1616341790689", id:"WinnerAlternate_320x50_Maryann_atlas_1"}
	],
	preloads: []
};
