...
lib.ssMetadata = [
		{name:"WinnerAlternate_1024x768_Maryann_atlas_1", frames: [[0,1518,1335,162],[0,770,1306,366],[1026,1138,829,231],[1026,0,809,667],[0,1138,1024,378],[0,0,1024,768],[1026,1371,174,136]]}
];
...
(lib.CachedBmp_32 = function() {
	this.initialize(ss["WinnerAlternate_1024x768_Maryann_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.WinnerAlternate1024x768Maryann = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Maryann_Top_Layer
	this.instance_4 = new lib.MaryannTopLayer_1();
	this.instance_4.setTransform(530.5,461.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({regX:1.2,regY:1.3,scaleX:1.0618,scaleY:1.0617,y:460},119).wait(1));
	...
	this.instance_6 = new lib.TS_Maryann_SyracuseNY_40163_FuNanFuNu_088wager_Feb14();
...
p.nominalBounds = new cjs.Rectangle(-524.3,350.4,2384.3,463.5);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/WinnerAlternate_1024x768_Maryann_atlas_1.png?1616343041236", id:"WinnerAlternate_1024x768_Maryann_atlas_1"}
	],
	preloads: []
};
