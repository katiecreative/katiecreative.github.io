...
lib.ssMetadata = [
		{name:"Winner_300x600_Carmella_atlas_1", frames: [[0,827,287,71],[0,0,482,278],[0,708,278,117],[0,280,300,426],[302,700,300,168],[302,280,168,52],[484,0,300,430],[302,334,100,79],[302,432,300,266]]}
];
...
(lib.CachedBmp_61 = function() {
	this.initialize(ss["Winner_300x600_Carmella_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-78.7,-20.5,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.WINNOW, new cjs.Rectangle(-78.7,-20.5,143.5,35.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-151.5,-71.8,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib._9213Jackpot, new cjs.Rectangle(-151.5,-71.8,241,139), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-84.25,-29.85,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib._4Bet, new cjs.Rectangle(-84.2,-29.8,139,58.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-150,-215);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Cutout_1, new cjs.Rectangle(-150,-215,300,430), null);
...
// stage content:
(lib.Winner300x600Carmella = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance_5.setTransform(0,432);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(120));

	// Cutout
	this.instance_6 = new lib.Cutout_1();
	this.instance_6.setTransform(150,375);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({scaleX:1.0833,scaleY:1.0833,x:149.95,y:376.25},119).wait(1));
	...
	this.instance_8.setTransform(0,161);
...
p.nominalBounds = new cjs.Rectangle(-25,294.6,337.5,314.6);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Winner_300x600_Carmella_atlas_1.png?1622771414379", id:"Winner_300x600_Carmella_atlas_1"}
	],
	preloads: []
};
