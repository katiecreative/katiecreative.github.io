...
lib.ssMetadata = [
		{name:"Winner_300x250_Carmella_atlas_1", frames: [[0,221,196,49],[562,0,427,81],[864,83,141,63],[0,0,300,219],[864,148,151,35],[302,0,258,220],[562,83,300,105],[562,190,300,70],[864,185,59,49]]}
];
...
(lib.CachedBmp_57 = function() {
	this.initialize(ss["Winner_300x250_Carmella_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-53.75,-14,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.WINNOW, new cjs.Rectangle(-53.7,-14,98,24.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-122.45,-21.4,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib._9213Jackpot, new cjs.Rectangle(-122.4,-21.4,213.5,40.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-42.55,-16.2,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib._4Bet, new cjs.Rectangle(-42.5,-16.2,70.5,31.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-129,-110);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Cutout_1, new cjs.Rectangle(-129,-110,258,220), null);
...
// stage content:
(lib.Winner300x250Carmella = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance_2.setTransform(204,18.35,0.0047,0.0248,0,0,0,-10.7,0);
	this.instance_2.shadow = new cjs.Shadow("rgba(0,0,0,1)",0,1,3);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(22).to({_off:false},0).to({scaleX:0.9997,scaleY:0.9997,x:190.15,y:18.4},29,cjs.Ease.elasticOut).wait(69));

	// $4_Bet_
	this.instance_3 = new lib._4Bet();
	this.instance_3.setTransform(-38.4,17.25,1,1,0,0,0,-7.4,-0.5);
	...
	this.instance_5.setTransform(158,151.7);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({regX:0.2,regY:0.1,scaleX:1.0775,scaleY:1.077,y:149.1},119).wait(1));
	...
	this.instance_8.setTransform(0,42.7);
...
p.nominalBounds = new cjs.Rectangle(66.5,110.2,385.5,157.3);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Winner_300x250_Carmella_atlas_1.png?1622771187504", id:"Winner_300x250_Carmella_atlas_1"}
	],
	preloads: []
};
