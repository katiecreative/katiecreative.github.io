...
lib.ssMetadata = [
		{name:"Winner_768x1024_Carmella_atlas_1", frames: [[1568,594,463,115],[770,744,796,475],[1568,399,460,193],[770,0,768,742],[1766,711,265,78],[1568,0,295,397],[0,0,768,743],[1568,711,196,154],[0,745,768,448]]}
];
...
(lib.CachedBmp_70 = function() {
	this.initialize(ss["Winner_768x1024_Carmella_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-127.1,-33.25,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.WINNOW, new cjs.Rectangle(-127.1,-33.2,231.5,57.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-250.25,-118.55,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib._9213Jackpot, new cjs.Rectangle(-250.2,-118.5,398,237.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-139.25,-49.4,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib._4Bet, new cjs.Rectangle(-139.2,-49.4,230,96.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-384,-371.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Cutout_1, new cjs.Rectangle(-384,-371.5,768,743), null);
...
// stage content:
(lib.Winner768x1024Carmella = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance_4.setTransform(384,652.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({scaleX:1.0521,scaleY:1.052,x:383.95,y:652.45},119).wait(1));
	...
	this.instance_8.setTransform(0,282);
...
p.nominalBounds = new cjs.Rectangle(134.8,511,910.2,532.3);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Winner_768x1024_Carmella_atlas_1.png?1622771653902", id:"Winner_768x1024_Carmella_atlas_1"}
	],
	preloads: []
};
